...
function claimReward(id) {
    ...
    fetch("https://piggy-bank-drsoxen.herokuapp.com:3000:3000/claimReward", {
        method: 'POST',
        headers: {
...
function completeQuest(id) {
    ...
    // Creates a promise object for sending the desired data
    fetch("https://piggy-bank-drsoxen.herokuapp.com:3000/completeQuest", {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
        },
...
function sendReward() {
    ...
    // Creates a promise object for sending the desired data
    fetch("https://piggy-bank-drsoxen.herokuapp.com:3000/createReward", {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
        },
...
function sendQuest() {
    ...
    // Creates a promise object for sending the desired data
    fetch("https://piggy-bank-drsoxen.herokuapp.com:3000/createQuest", {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
        },
...
function sendTip() {
    ...
    // Creates a promise object for sending the desired data
    fetch("https://piggy-bank-drsoxen.herokuapp.com:3000/createTip", {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
        },
...
function sendPayment() {
    ...
    // Creates a promise object for sending the desired data
    fetch("https://piggy-bank-drsoxen.herokuapp.com:3000/payment", {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
        },
...
function sendModification(action) {
    ...
    // Creates a promise object for sending the desired data
    fetch("https://piggy-bank-drsoxen.herokuapp.com:3000/modification", {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
        },
...
function sendToggleStar(id) {
    ...
    // Creates a promise object for sending the desired data
    fetch("https://piggy-bank-drsoxen.herokuapp.com:3000/toggleStar", {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
        },
